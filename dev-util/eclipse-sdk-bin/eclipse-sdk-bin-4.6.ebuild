...
SR="R"
SRC_BASE="http://www.eclipse.org/downloads/download.php?file=/technology/epp/downloads/release/neon/${SR}/eclipse-java-neon-${SR}-linux-gtk"
...
SRC_URI="
	amd64? ( ${SRC_BASE}-x86_64.tar.gz${MIRROR} -> eclipse-java-luna-${SR}-linux-gtk-x86_64-${PV}.tar.gz )
	x86? ( ${SRC_BASE}.tar.gz${MIRROR} -> eclipse-java-luna-${SR}-linux-gtk-${PV}.tar.gz )"
